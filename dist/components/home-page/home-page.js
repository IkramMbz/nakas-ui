...
const HomePage = () => {
    ...
    // };
    return (_jsxs("div", { className: "nakas-ui-landing shimmer", children: [_jsx(AuroraBackground, { showRadialGradient: true, lowOpacity: true }), _jsx("div", { className: "screen", children: _jsxs("div", { className: "inner", style: { backgroundColor: colors.background }, children: [_jsx(NotificationBar, { author: currentTheme.author, authorUrl: currentTheme.authorUrl || null, backgroundColor: `linear-gradient(to right, ${colors["primary-accent"]}, ${colors["secondary-accent"]})`, color: colors["secondary-accent"] }), _jsxs("div", { className: "main", children: [_jsx(Header, {}), _jsxs("main", { id: "main-content", children: [_jsx(LandingDemoKPI, { themes: visibleThemes.slice(0, 3) }), _jsxs("div", { className: "flex flex-col items-center justify-center", style: { gap: "2rem" }, children: [_jsx("div", { className: "header", children: visibleThemes.map(({ theme, position, isCurrent }) => (_jsx("div", { className: "flex-col items-center", children: _jsx("button", { className: `planet ${isCurrent ? "big scale-110" : "w-24 h-24 opacity-60 hover:opacity-80"}`, style: {
