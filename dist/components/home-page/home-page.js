...
const HomePage = () => {
    ...
    return (_jsxs("div", { className: "nakas-ui-landing", children: [_jsx(AuroraBackground, { showRadialGradient: true, lowOpacity: true }), _jsx("div", { className: "screen", children: _jsxs("div", { className: "inner", style: { backgroundColor: colors.background }, children: [_jsx(NotificationBar, { author: currentTheme.author, authorUrl: currentTheme.authorUrl || null, backgroundColor: `linear-gradient(to right, ${colors["primary-accent"]}, ${colors["secondary-accent"]})`, color: colors["nega-bold-color"] }), _jsxs("div", { className: "main", children: [_jsx(Header, {}), _jsxs("main", { id: "main-content", children: [_jsx(LandingDemoKPI, { themes: visibleThemes }), _jsxs("div", { className: "flex flex-col items-center justify-center", style: { gap: "2rem" }, children: [_jsx("div", { className: "header", children: visibleThemes.map(({ theme, position, isCurrent }) => (_jsx("div", { className: "flex-col items-center", children: _jsx("button", { className: `planet ${isCurrent ? "big scale-110" : "w-24 h-24 opacity-60 hover:opacity-80"}`, style: {
                                                            ...
                                                            } }) }, `${theme.name}-${position}`))) }), _jsxs(Heading, { type: "h1", animated: true, children: ["Construisez avec le th\u00E8me", " ", _jsx("span", { className: "text-gradient", style: {
                                                                ...
                                                                color: "transparent",
                                                            }, children: currentTheme.name })] }), _jsx(BodyText, { size: "xl", className: "mb-4", children: "Nakas UI est un espace d'exploration (playground) d\u00E9di\u00E9 au design d'interfaces. Il met en avant des th\u00E8mes visuels pens\u00E9s pour la coh\u00E9rence, la lisibilit\u00E9 et l'identit\u00E9 des produits de l'univers Nakas." }), _jsx(ThemeSwitcher, {})] })] })] })] }) })] }));
};
