...
const LandingDemoKPI = ({ themes, }) => {
    ...
    return (_jsxs("div", { className: "landing-demo-kpi", children: [themes.slice(0, 3).map(({ theme, position }, index) => (_jsx("div", { className: "theme-wrapper", children: _jsx("div", { className: "theme-kpi-button", style: {
