...
export const validateTheme = (theme: unknown): theme is Theme => {
  ...
  if (!t.light?.colors || !t.dark?.colors) return false;
...
export const sanitizeTheme = (theme: Theme, defaultTheme: Theme): Theme => {
...
export const serializeTheme = (theme: Theme): string => {
  try {
...
export const deserializeTheme = (cookieValue: string | null): Theme | null => {
